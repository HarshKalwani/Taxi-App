            ...
            <div className="flex justify-between items-center flex-col gap-5">
                ...
                <div className='mt-6 w-full'>
                    <form onSubmit={(e) => {
                        ...
                        <input type="number" 
                            placeholder='Enter OTP ' className="bg-[#eee] px-6 py-4 text-base font-mono rounded-lg w-full mt-5"
                            value={otp}
                            onChange={(e) => setOtp(e.target.value)}
                        />
                        <Link
                            to='/captain-riding'
                            className='w-full mt-5 bg-green-500 text-lg text-white font-semibold p-3 rounded-lg flex items-center justify-center'
                            onClick={() => {
                        ...
                        <button
                            className='w-full mt-5 bg-red-600 text-lg text-white font-semibold p-3 rounded-lg'
                            onClick={() => {
                                // setVehicleFound(true)
                                // setConfirmRidePanel(false)
                                // setRidePopUpPanel(false)
